...
x= tf.keras.layers.Flatten(name='flatten')(max_pool_3)
...
optimizer = tf.train.AdadeltaOptimizer(learning_rate=0.1)#Inistising your optimising functions
...
for loop in range(epochs):
    ...
    for (batch_X, batch_y) in ds.batch_iterator(batch_size=20, shuffle=True):#shuffle true will randomise every batch
